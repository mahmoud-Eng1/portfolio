...
const Index = () => {
  return (
    <section className="pt-[100px] mt-[100px]">
    <div className="container parentHome ">
      <div className="infoName w-[320px] max-w-full m-auto px-2">
        <div className="  m-[30px]">
        <a className="bg-main py-[5px] px-[10px] text-[20px] rounded"  href={"/cv.pdf"} download={true}> download cv</a>
        </div>
